...
Public Class ClsTipoPermiso
    ...
    Public Function RegistrarNuevaTipoPermiso() As String
        ...
        sqlcom.CommandText = "M_slmInsertarTipoPermiso"
    ...
    Public Function ModificarTipoPermiso() As String
        Dim sqlcom As SqlCommand
        Dim sqlpar As SqlParameter
        Dim par_sal As Integer
        ...
        sqlcom = New SqlCommand
        sqlcom.CommandType = CommandType.StoredProcedure
        sqlcom.CommandText = "M_slmModificarTipoPermiso"
    ...
    Public Function BuscarTipoPermiso() As DataTable
        ...
        Using cmd As New SqlCommand
            ...
            cmd.CommandText = "M_slmBuscarTipoPermiso"
    ...
    Public Function SeleccionarTipoPermiso() As DataTable
        Dim objCon As New ClsConnection
        Dim cn As New SqlConnection
        cn = objCon.getConexion

        Using da As New SqlDataAdapter("M_slmSeleccionarTipoPermiso", cn)
